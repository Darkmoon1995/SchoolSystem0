        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasBudgetControl = table.Column<bool>(type: "INTEGER", nullable: false),
                    HasCurriculumControl = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseManagers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BaseManagers_Managers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseManagerId = table.Column<int>(type: "INTEGER", nullable: true),
                    ManagerId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_BaseManagers_BaseManagerId",
                        column: x => x.BaseManagerId,
                        principalTable: "BaseManagers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_BaseManagers_BaseManagerId",
                        column: x => x.BaseManagerId,
                        principalTable: "BaseManagers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Classes_Managers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "Managers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Costs_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseManagers_ManagerId",
                table: "BaseManagers",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_Classes_BaseManagerId",
                table: "Classes",
                column: "BaseManagerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_BaseManagerId",
                table: "Teachers",
                column: "BaseManagerId");
